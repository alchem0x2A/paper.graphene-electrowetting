...
\documentclass[journal=langd5,manuscript=article,email=true,hyperref=true,keywords=true]{achemso}
\usepackage{graphicx}
\setkeys{acs}{maxauthors = 0}   %no truncation
\usepackage{float}
\usepackage{xcolor}
\usepackage{amsmath}
\usepackage{fontspec}
\usepackage[section]{placeins}  %enable section number
\SectionNumbersOn
\author{Tian Tian}
...
\caption{\label{fig:f-nc-exp} Comparison between model and
  ...
  Ref. \citenum{hong_mechanism_2016}; the ESEM data are extracted from
  Ref. \citenum{ashraf_doping-induced_2016}.}
\end{figure}
