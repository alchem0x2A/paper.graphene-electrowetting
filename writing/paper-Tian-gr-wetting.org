...
\begin{abstract}
  ...
  (EDL) formed in the liquid phase (continuum level,
...
molecular scale (10^{0} ~ 10^{1} nm). The effect of the electrical
...
then addressed at the continuum level (10^{0} ~ 10^{4} nm). Practical
