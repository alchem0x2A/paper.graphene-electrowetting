...
Schemes of the void region in (a) substrated doped 2D material and (b) electrostatic gated 2D material.(c) Fitted experimental data of \(\Delta\cos\theta\) as a function of \(\sigma_{\mathrm{2D}}\). The electrowetting data are extracted from Ref. \citenum{hong_mechanism_2016}; the ESEM data are extracted from Ref. \citenum{ashraf_doping-induced_2016}.}
\end{figure}
