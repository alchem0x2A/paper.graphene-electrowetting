...
\usepackage{amsmath}
\usepackage{fontspec}
\keywords{Two-dimensional materials, doping, wettability, multiscale analysis, MD Simulation, eletrical double layer}
\author{Tian Tian}
...
\textbf{\textsf{\textsc{TODO}}} Explanation of the positive part of \(\Delta \Phi\) when \(\sigma_{\mathrm{2D}} \approx -2\) ?
...
\fbox{
\begin{minipage}[c]{.8\linewidth}
\textbf{\textsf{\textsc{TODO}}} Try find other references?
