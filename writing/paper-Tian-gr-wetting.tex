% Created 2017-07-24 Mon 23:13
% Intended LaTeX compiler: pdflatex
\documentclass[journal=jacsat,manuscript=article,email=true,hyperref=true,keywords=true]{achemso}
 \usepackage{minted}
 \usepackage{graphicx}
\usepackage{float}
\usepackage{xcolor}
...
\affiliation{Institute for Chemical and Bioengineering, ETH Z{\"{u}}rich,  Vladimir Prelog Weg 1, CH-8093 Z{\"{u}}rich, Switzerland}
\keywords{two-dimensional materials, doping, wettability, multiscale analysis, MD Simulation, electrical double layer}
\date{}
...
\begin{abstract}
  ...
  (EDL) formed in the liquid phase (mesoscopic scale,
...
molecular scale (10\(^{\text{0}}\) \textasciitilde{} 10\(^{\text{1}}\) nm). The effect of the electrical
...
then addressed at the continuum level (10\(^{\text{0}}\) \textasciitilde{} 10\(^{\text{4}}\) nm). Practical
